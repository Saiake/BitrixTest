<?php
define('C_REST_CLIENT_ID','local.642dbcbb7194d1.76980485');//Application ID
define('C_REST_CLIENT_SECRET','FxF1polq7DxHHVfGMpJapvRXPU6OwPhh7QaiGUNJmYsHjnobxZ');//Application key
// or
